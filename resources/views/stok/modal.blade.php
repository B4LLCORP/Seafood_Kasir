    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-success" id="exampleModalLabel">Tambah Data Stok</h5>
            ...
            <div class="modal-body">
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="NamaProduk" id="NamaBarang" placeholder="Masukan nama produk">
                    </div>
                    <div class="form-group">
